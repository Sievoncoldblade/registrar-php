						...
						<?php switch ($office_name) { 
                            ...
                            case 'Academic Office':
                                ...
                                case 'Registrar Office':
                                    echo '
                                    <li><a class="dropdown-item" href="create_request.php">Create Request</a></li>
                                    <li><a class="dropdown-item" href="your_transaction.php">Your Registrar Request</a></li>
                                    <li><a class="dropdown-item" href="registrar_history.php">Registrar Transaction History</a></li>
                                    ';
				...
				<div class="d-flex navbar-nav justify-content-center me-auto order-2 order-lg-1 w-100">
					<form class="d-flex w-100">
						<input class="form-control me-2" type="search" placeholder="Search for services..." aria-label="Search"
							maxlength="50">
						<button class="btn search-btn btn-warning" type="submit"><strong>Search</strong></button>
					</form>
				</div>
